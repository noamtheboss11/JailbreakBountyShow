...
local function findOriginalBoard()
	...
	for _, obj in ipairs(workspace:GetDescendants()) do
		if obj:IsA("UIGridLayout") and obj.Parent and obj.Parent:IsA("Frame") then
			return obj.Parent
		end
	end
	-- Method 3: structural
	for _, obj in ipairs(workspace:GetDescendants()) do
		if obj:IsA("Frame") then
			...
			for _, child in ipairs(obj:GetChildren()) do
				if child:IsA("UIGridLayout") then hasList = true end
...
local function createBountyWindow()
	...
	UIGridLayout.CellSize = UDim2.new(0, 415, 0, 220)
	UIGridLayout.FillDirection = Enum.FillDirection.Vertical
	UIGridLayout.Parent = bountyScrollingFrame
